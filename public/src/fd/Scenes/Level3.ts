...
export default class Level3 extends Scene {
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.monsterHealth = 54;
        this.monsterMaxHealth = 54;
    ...
    public override loadScene() {
        ...
        this.load.object("enemy_location", "fd_assets/data/enemies/level3_monster.json");

        // Load the seed locations
        this.load.object("seeds", "fd_assets/data/items/level3_seed.json");
        this.load.object("shop", "fd_assets/data/items/shop.json");
        this.load.object("pearls", "fd_assets/data/items/level3_pearl.json");
    ...
    public handleEvent(event: GameEvent): void {
        ...
        switch (event.type) {
            ...
            case ShopEvent.GET_NEW_SEED: {
                ...
                this.seeds.push(new Seed(sprite, 3));
    ...
    protected initializeMonsters(): void {
        ...
        for (let i = 0; i < enemy.enemies.length; i++) {
            ...
            npc.addAI(EnemyBehavior, {target: this.battlers[0], range: 800, level: 3});
    ...
    protected initializeItems(): void {
        ...
        for (let i = 0; i < seeds.items.length; i++) {
            let sprite = this.add.sprite("seed", "primary");
            this.seeds[i] = new Seed(sprite, 3);
